...
class Communities {
  ...
  static create (userId, communityName, displayName, headline, description, sprite, seed) {
    const queryText =
  ...
  static update (communityId, displayName, headline, description, sprite, seed) {
    const queryText = 'UPDATE communities SET display_name = $1, headline = $2, description = $3, sprite = $4, seed = $5 WHERE id = $6'
    return query(queryText, [displayName, headline, description, sprite, seed, communityId])
  }
